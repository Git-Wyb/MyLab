...
void ADF7030_RECEIVING_FROM_POWEROFF_testMode(u32 PROFILE_CH)
{
    ...
    PROFILE_CH_FREQ_32bit_200002EC = PROFILE_CH;
    ADF7030_WRITE_REGISTER_NOPOINTER_LONGADDR_MSB(ADDR_CHANNEL_FERQUENCY, PROFILE_CH_FREQ_32bit_200002EC); //
    WaitForADF7030_FIXED_DATA();                                                                           //�ȴ�оƬ����/�ɽ���CMD״̬
    DELAY_30U();
    ADF7030_Clear_IRQ();
...
void ADF7030_TX(u8 mode,u32 PROFILE_CH)
{
    ...
    WaitForADF7030_FIXED_DATA(); //等待芯片空闲/可接受CMD状�??
    DELAY_30U();
    PROFILE_CH_FREQ_32bit_200002EC = PROFILE_CH;//429175000;
    ADF7030_WRITE_REGISTER_NOPOINTER_LONGADDR_MSB(ADDR_CHANNEL_FERQUENCY, PROFILE_CH_FREQ_32bit_200002EC); //
    WaitForADF7030_FIXED_DATA();                                                                           //等待芯片空闲/可接受CMD状�??
    DELAY_30U();
    ADF7030_WRITE_REGISTER_NOPOINTER_LONGADDR(ADDR_TXPACKET_DATA, CONST_TXPACKET_DATA_20000AF0, OPEN_LONG);
	...
	**/
	void APP_TX_PACKET(void)
	{
	 ...
	 //if((TP3==0)&&(FLAG_Key_TP3==0))FLAG_Key_TP3=1;
      ...
      if((Flag_FREQ_Scan==0)&&((PROFILE_CH_FREQ_32bit_200002EC == 429175000)||(PROFILE_CH_FREQ_32bit_200002EC == 429200000))&&
